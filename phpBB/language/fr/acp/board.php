...
$lang = array_merge($lang, array(
	...
	'USE_SYSTEM_CRON_EXPLAIN'	=> 'Lorsqu’il est désactivé, phpBB s’arrangera pour que les tâches périodiques soient exécutées automatiquement. Lorsqu’il est activé, phpBB ne planifiera aucune tâche périodique par lui-même ; Un administrateur système doit faire en sorte que <code>bin/phpbbcli.php cron:run</code> soit exécuté par la fonction cron du système d’exploitation à intervalles réguliers (par exemple toutes les 5 minutes).',
));
