...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_HTTP_AUTH_EXPLAIN'		=> 'Active l’authentification HTTP, permettant aux membres d’accéder au contenu masqué aux invités en ajoutant le paramètre <samp>auth=http</samp> à l’URL du flux. Notez que certaines configurations PHP peuvent nécessiter des modifications supplémentaires dans le fichier .htaccess ; consultez ce fichier pour plus d’instructions. L’authentification HTTP n’est prise en charge que sur les connexions chiffrées (https).',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_DOMAIN_EXPLAIN'		=> 'Dans la plupart des cas, le domaine des cookies est facultatif. En cas de doute, laissez ce champ vide.<br><br>Dans le cas où vous auriez un forum intégré avec un autre logiciel ou de multiples domaines, alors pour déterminer le domaine des cookies procédez comme suit. Si vous avez quelque chose comme <i>exemple.com</i> et <i>forums.exemple.com</i>, ou <i>forums.exemple.com</i> et <i>blog.exemple.com</i>. Retirez les sous-domaines jusqu’à obtenir le nom de domaine commun, <i>exemple.com</i>. Puis, faites précéder le nom de domaine obtenu avec un point, ce qui donnerait « .exemple.com » (veuillez observer qu’un point se trouve devant le nom de domaine).',
	'COOKIE_NAME'				=> 'Nom des cookies',
	'COOKIE_NAME_EXPLAIN'		=> 'Saisissez ce que vous souhaitez, faites original. À chaque modification des paramètres des cookies, le nom des cookies doit être changé.',
	...
	'COOKIE_PATH_EXPLAIN'		=> 'Il s’agira généralement de la même valeur que le chemin du script ou saisissez simplement une barre oblique « / » pour rendre les cookies accessibles via n’importe quelle URL de votre forum.',
...
$lang = array_merge($lang, array(
	...
	'USE_SMTP_EXPLAIN'				=> 'Sélectionnez « Oui » si vous voulez ou devez envoyer les courriels par l’intermédiaire d’un serveur au lieu d’utiliser la fonction mail() locale.',
));
...
$lang = array_merge($lang, array(
	...
	'JAB_GTALK_NOTE'				=> 'Notez que GTalk ne marchera pas car la fonction <samp>dns_get_record</samp> est introuvable. Cette fonction n’est pas disponible dans PHP4 et elle n’est pas implémentée sur les environnements Windows. Cela ne fonctionne pas non plus sur les systèmes basés sous BSD, y compris Mac OS.',
