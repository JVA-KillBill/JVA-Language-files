...
$lang = array_merge($lang, array(
	...
	'JV_POKER_BIG_BLIND'				=> 'Großer Starteinsatz',
	'JV_POKER_CHAIRS'					=> 'Stühle',
	'JV_POKER_CHIPS'					=> 'Chips',
	'JV_POKER_CHIPS_BALANCE'			=> 'Chips Kontostand: <strong>%s</strong>',
	...
	'JV_POKER_FILE_LOAD_ERROR'			=> 'Laden der Datei %s fehlgeschlagen!',
	'JV_POKER_FIX_LIMIT'				=> 'Festes Limit',
	'JV_POKER_GAME_INFO'				=> 'Spielinformation',
	'JV_POKER_GAME_TIME'				=> 'Spielzeit',
	'JV_POKER_INCOME'					=> 'Einkommen: <strong>%s</strong>',
	'JV_POKER_INDEX'					=> 'Poker Übersicht',
	'JV_POKER_JACKPOT'					=> 'Jackpot',
	'JV_POKER_JVA_CORE_EXT_DISABLED'	=> 'Das „JVA - Core“ extension wurde deaktiviert!',
	...
	'JV_POKER_NOT_FINISHED'				=> 'Nicht beendet!',
	'JV_POKER_NOT_FOUND_ROOM'			=> 'Der angeforderte Raum wurde nicht gefunden!',
	'JV_POKER_NOT_LOGGED'				=> 'Du bist im Forum nicht angemeldet!',
	...
	'JV_POKER_NO_PERMISSION_PLAY'		=> 'Du hast keine ausreichende Berechtigung, um Poker zu spielen.',
	'JV_POKER_NO_PLAYED_USERS'			=> 'Derzeit hast du noch nicht Poker gespielt.',
	...
	'JV_POKER_POINTS_SYSTEM_DISABLED'	=> 'Das Points System-Feature wurde deaktiviert!',
	...
	'JV_POKER_ROOM_CLOSE'				=> 'Alle Stühle in diesem Raum sind besetzt. Es können keine weiteren Spieler den Raum betreten. Bitte warte, bis mindestens ein Stuhl frei wird.',
	'JV_POKER_ROOM_CLOSE_TOURNAMENT'	=> 'Das Turnier hat bereits begonnen. Zusätzlichen Spielern ist es nicht erlaubt, den Raum zu betreten.',
	'JV_POKER_ROOM_DISABLED'			=> 'Poker ist derzeit deaktiviert.',
	'JV_POKER_ROOM_LOCKED'				=> 'Dieser Raum wurde geschlossen!',
	'JV_POKER_ROOM_NAME'				=> 'Name',
	'JV_POKER_ROOM_NAME_ACTIVE'			=> '%s Raum',
	'JV_POKER_ROOM_PLAYERS'				=> 'Mitglieder/Stühle',
	...
	'JV_POKER_SMALL_BLIND'				=> 'Kleiner Starteinsatz',
	'JV_POKER_STANDARD'					=> 'Normal',
	'JV_POKER_STANDARD_ROOM'			=> 'Normaler Raum',
	'JV_POKER_STANDARD_ROOMS'			=> 'Normale Räume',
	...
	'JV_POKER_STATS_INCOME'				=> 'Einkommen: %s',
	...
	'JV_POKER_STATS_WINS_RATE'			=> 'Gewinnrate:%s%%',
	'JV_POKER_STATS_WON_TOURS'			=> array(
		1								=> 'gewann %s Turnier.',
		2								=> 'gewann %s Turniere.',
	),
	'JV_POKER_TIME_DAY'					=> 'Tag',
	'JV_POKER_TIME_DAYS'				=> 'Tage',
	'JV_POKER_TIME_HOUR'				=> 'Stunde',
	'JV_POKER_TIME_HOURS'				=> 'Stunden',
	'JV_POKER_TIME_MINUTE'				=> 'Minute',
	'JV_POKER_TIME_MINUTES'				=> 'Minuten',
	'JV_POKER_TIME_MONTH'				=> 'Monat',
	'JV_POKER_TIME_MONTHS'				=> 'Monate',
	'JV_POKER_TIME_SECOND'				=> 'Sekunde',
	'JV_POKER_TIME_SECONDS'				=> 'Sekunden',
	'JV_POKER_TIME_WEEK'				=> 'Woche',
	'JV_POKER_TIME_WEEKS'				=> 'Wochen',
	'JV_POKER_TIME_YEAR'				=> 'Jahr',
	'JV_POKER_TIME_YEARS'				=> 'Jahre',
