...
$lang = array_merge($lang, [
	...
	'JV_POKER_BALANCE'					=> 'Jetons : <strong>%s</strong>',
	...
	'JV_POKER_CHIPS_EXCHENGE_SUCCESS'	=> '%s jetons ont été échangés avec succès.',
	'JV_POKER_CHIPS_FORMAT'				=> 'KMBT',
	'JV_POKER_CHIPS_PF'					=> 'jetons : %s',
	...
	'JV_POKER_EXCHANGE_TYPE_CHIPS'		=> '%s » jetons',
	'JV_POKER_EXCHANGE_TYPE_POINTS'		=> 'Jetons » %s',
	...
	'JV_POKER_HI_JP_WIN'				=> '{color}%s{/color} vient de gagner{color}%d{/color}des jetons du JackPot.',
	...
	'JV_POKER_RETURN_EXCHENGE_PAGE'		=> '%sRetour à la page d’échange de jetons.%s',
	...
	'JV_POKER_TOTAL_DATA_CHIPS'			=> 'Total des jetons : <strong>%s</strong>',
