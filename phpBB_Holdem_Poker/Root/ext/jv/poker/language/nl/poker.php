...
$lang = array_merge($lang, [
	...
	'JV_POKER_AMOUNT_BALANCE_ERROR'		=> 'Het bedrag dat u opgeeft, is hoger dan uw balans.',
	...
	'JV_POKER_CHIPS_EXCHANGE_EXPLAIN'	=> 'Voer het bedrag in dat je omwisselt voor fiches.',
	'JV_POKER_CHIPS_EXCHENGE_COST'		=> 'Ook werden de kosten van %s in mindering gebracht op uw %s balans.',
	...
	'JV_POKER_EXCHANGE_COST_ERROR'		=> 'Het opgegeven bedrag en de bijbehorende kosten zijn hoger dan uw saldo. Het maximale omwisselbedrag is %s.',
	...
	'JV_POKER_PLAYING_ROOMS_USER'		=> 'Er is momenteel %s kamers in gebruik, met een totaal van %s gebruiker.',
	'JV_POKER_PLAYING_ROOMS_USERS'		=> 'Er is momenteel %s kamers in gebruik, met een totaal van  %s gebruikers.',
	...
	'JV_POKER_TOTAL_DATA_CHIPS'			=> 'Totaal aantal chips : <strong>%s</strong>',
	'JV_POKER_TOTAL_MSG'				=> 'Totaal aantal berichten %s',
	'JV_POKER_TOTAL_TOURS'				=> 'Totaal aantal toernooi’s (%s)',
