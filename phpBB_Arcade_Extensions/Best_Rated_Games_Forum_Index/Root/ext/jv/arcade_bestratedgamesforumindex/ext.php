...
* @version $Id: ext.php 2377 2021-01-27 12:37:15Z KillBill $
...
namespace jv\arcade_bestratedgamesforumindex;
...
class ext extends base
{
	public function is_enableable()
	{
		...
		if ($error)
		{
			...
			$lang->add_lang('error', 'jv/arcade_bestratedgamesforumindex');

			trigger_error($lang->lang('ARCADE_EXT_BRG_ERROR_ENABLE' . $error, $rv), E_USER_WARNING);
		}
