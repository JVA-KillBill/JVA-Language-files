...
namespace jv\arcade_randomgamesforumindex;
...
class ext extends base
{
	public function is_enableable()
	{
		...
		if ($error)
		{
			...
			$lang->add_lang('error', 'jv/arcade_randomgamesforumindex');

			trigger_error($lang->lang('ARCADE_EXT_RGF_ERROR_ENABLE' . $error, $rv), E_USER_WARNING);
		}
