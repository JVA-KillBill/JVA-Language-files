...
$lang = array_merge($lang, [
	...
	'JVPPDMT_ONLY_ALREADY_EXISTING_DATA'	=> 'De reeds opgeslane gegevens keur ik goed, maar verder niets.<br><em>Houd er rekening mee dat, als je voor deze optie kiest, je je in een groep bevindt die alleen in aanmerking komt voor weergave. Uiteraard kan je deze beslissing later in de gebruikerspaneel/privacygegevens instellingen wijzigen.</em>',
	'JVPPDMT_ONLY_REGISTER_DATA'			=> 'De persoonlijke gegevens die vereist zijn voor registratie keur ik goed, maar verder niets.<br><em>Houd er rekening mee dat, als je voor deze optie kiest, je je in een groep bevindt die alleen in aanmerking komt voor weergave. Uiteraard kan je deze beslissing later in het gebruikerspaneel/privacygegevens instellingen wijzigen.</em>',
...
Beperking van verwerking is het markeren van opgeslane persoonlijke gegevens met het doel hun verwerking in de toekomst te beperken.

<strong>e) Verantwoordelijke verantwoordelijk voor de verwerking</strong>
Verantwoordelijke die verantwoordelijk is voor de verwerking is de natuurlijke of rechtspersoon, overheidsinstantie, agentschap of andere instantie die, alleen of samen met anderen, de doeleinden en middelen voor de verwerking van persoonsgegevens bepaalt; wanneer het doel en de middelen van een dergelijke verwerking worden bepaald door het recht van de Unie of de lidstaten, kan de voor de verwerking verantwoordelijke of de specifieke criteria voor de aanwijzing ervan door de wetgeving van de Unie van de lidstaten worden geregeld.
...
De ontvanger is een natuurlijke persoon of rechtspersoon, een overheidsinstantie, een agentschap of een andere instantie waaraan de persoonsgegevens worden verstrekt, ongeacht of deze derden zijn of niet. Overheidsinstanties die in het kader van een bepaald onderzoek persoonsgegevens kunnen ontvangen in overeenstemming met de wetgeving van de Unie van de lidstaten, worden echter niet als ontvangers beschouwd; de verwerking van die gegevens door die overheidsinstanties moet in overeenstemming zijn met de toepasselijke gegevensbeschermingsregels overeenkomstig met de doeleinden van de verwerking.

<strong>h) Derde party</strong>
Derde partij is een natuurlijke of rechtspersoon, overheidsinstantie of instantie die niet de betrokkene, verantwoordelijke, verwerker en persoon is die, onder het directe gezag van de verantwoordelijke voor de verwerking of de verwerker, gemachtigd zijn om persoonsgegevens te verwerken.
...
<h3>Gegevens van de verantwoordelijke</h3>
Verantwoordelijke in het kader van de Algemene Verordening Gegevensbescherming (AVG), andere wetgeving inzake gegevensbescherming die van toepassing is in de lidstaten van de Europese Unie en andere bepalingen met betrekking tot gegevensbescherming is:

<strong>Verantwoordelijke:</strong> %2$s
...
De betrokkene heeft de mogelijkheid om zich op de website van de verantwoordelijke te registreren met vermelding van persoonsgegevens. De registratie van de betrokkene, met vrijwillige vermelding van persoonsgegevens, is bedoeld om de voor de verwerking verantwoordelijke in staat te stellen de inhoud van de gegevenssubjecten of diensten aan te bieden die alleen aan geregistreerde gebruikers kunnen worden aangeboden vanwege de aard van de zaak in kwestie. Welke persoonlijke gegevens naar de verantwoordelijke worden verzonden, wordt bepaald door het respectievelijke invoermasker dat voor de registratie wordt gebruikt. De persoonlijke gegevens die door de betrokkene worden ingevoerd, worden uitsluitend voor intern gebruik door de verantwoordelijke voor eigen doeleinden verzameld en opgeslaan.

Om een account te registreren op de website van de verantwoordelijke, zijn ten minste de volgende persoonlijke gegevens vereist: een unieke identificeerbare gebruikersnaam, een persoonlijk wachtwoord dat wordt gebruikt om in te loggen op je account en een persoonlijk geldig e-mailadres. Dit e-mailadres is vereist om de bevestigingslink te ontvangen die wordt gebruikt om de registratie te verifiëren en om verdere berichten van de website te ontvangen. De verdere berichten kunnen optioneel worden geselecteerd en gedeselecteerd in het gebruikerspaneel na het succesvol aanmelden. Je wachtwoord is versleuteld (een one-way hash) zodat het veilig is. Het wordt echter aanbevolen dat je hetzelfde wachtwoord niet opnieuw gebruikt op een aantal verschillende websites. Je wachtwoord is het middel om toegang te krijgen tot je account op deze website, dus bewaar het zorgvuldig. In geen geval zal iemand die is aangesloten bij deze website of een andere derde partij, je wettig om je wachtwoord vragen. Als je je wachtwoord voor je account bent vergeten, kan je de “Ik ben mijn wachtwoord vergeten” functie van de software gebruiken. Dit proces vraagt je om de gebruikte gebruikersnaam en het e-mailadres in te voeren dat je in je profiel hebt ingevoerd. Vervolgens genereert de software een nieuw wachtwoord om je account terug te vorderen. Om deze reden is het aanbevolen om het e-mailadres altijd up-to-date te houden.

Door zich te registreren op de website van de verantwoordelijke, worden ook het IP-adres toegewezen door de internetprovider (ISP) en gebruikt door de datum van het onderwerp en het tijdstip van registratie geregistreerd. De opslag van deze gegevens vindt plaats op de achtergrond omdat dit de enige manier is om misbruik van onze diensten te voorkomen en, indien nodig, om het mogelijk te maken om gepleegde delicten te onderzoeken. In zoverre is de opslag van deze gegevens noodzakelijk om de verantwoordelijke te beveiligen. Deze gegevens worden niet doorgegeven aan derden tenzij er een wettelijke verplichting is om de gegevens door te geven of als de overdracht strafrechtelijke vervolging tot doel heeft.

Door zich te registreren op de website van de verantwoordelijke, stelt de betrokkene de verantwoordelijke in staat om de gegevens die zijn ingevoerd door de betrokkene op te slaan als onderdeel van de registratie en in het profiel, evenals doorlopende toegangsgegevens (datum en tijd van gebruik, IP-adres locatiegegevens, scores en andere gegevens verzonden door de browser van de betrokkene), en te gebruiken voor de werking van de website. Opgemerkt moet worden dat alle gegevens die in het profiel zijn ingevoerd en berichten die door de betrokkene zijn geschreven, afhankelijk van de configuratie op internet beschikbaar kunnen zijn en door iedereen kunnen worden opgeroepen. Bovendien staat de betrokkene toe dat de website contact opneemt om de administratieve berichten te verzenden die nodig zijn om het gebruikersaccount te openen en te beheren.

Het staat geregistreerde personen vrij om op elk moment de persoonlijke gegevens te wijzigen die tijdens de registratie zijn opgegeven, of deze volledig uit de data opslag van de verantwoordelijke te verwijderen.

De voor de verwerking verantwoordelijke verstrekt op elk moment op verzoek informatie aan elke betrokkene over welke persoonsgegevens over de betrokkene zijn opgeslaan. Bovendien corrigeert of wist de voor de verwerking verantwoordelijke persoonsgegevens op verzoek of op aanwijzing van de betrokkene, voor zover er geen wettelijke opslag verplichtingen zijn. Het geheel van de medewerkers van de verantwoordelijke is in dit opzicht beschikbaar voor de betrokkene als contactpersonen.
...
De verantwoordelijke heeft de Gravatar service op deze website geïntegreerd om de hulp van Gravatar te kunnen gebruiken om postschrijvers en commentaar schrijvers de gelegenheid te geven hun berichten te personaliseren met een profielfoto (ook bekend als een avatar). De exploitant van de dienst Gravatar is het Automattic Inc., 132 Hawthorne Street San Francisco, CA 94107, VS.
...
Het doel van de AdSense component van Google is de integratie van advertenties op onze website. Google AdSense plaatst een cookie in het informatietechnologie systeem van de betrokkene. De definitie van cookies is hierboven uitgelegd. Met de instelling van de cookie kan Alphabet Inc. het gebruik van onze website analyseren. Bij elke oproep naar een van de afzonderlijke pagina’s van deze internetsite, die wordt beheerd door de verantwoordelijke en waarin een Google AdSense component is geïntegreerd, verzendt de internetbrowser op het informatietechnologie systeem van de betrokkene automatisch gegevens via de Google AdSense component ten behoeve van online adverteren en de afrekening van commissies bij Alphabet Inc. Tijdens deze technische procedure verwerft de onderneming Alphabet Inc. kennis van persoonlijke gegevens, zoals het IP-adres van de betrokkene, dat het alfabet dient Inc., onder meer om de oorsprong van bezoekers en klikken te begrijpen en vervolgens provisies te maken.
...
Google Analytics plaatst een cookie op het informatietechnologie systeem van de betrokkene. De definitie van cookies is hierboven uitgelegd. Met het instellen van de cookie kan Google het gebruik van onze website analyseren. Bij elke oproep naar een van de afzonderlijke pagina’s van deze internetsite, die wordt beheerd door de verantwoordelijke en waarin een Google Analytics component is geïntegreerd, verzendt de internetbrowser op het informatietechnologie systeem van de betrokkene automatisch gegevens via de Google Analytics-component ten behoeve van online adverteren en de afrekening van commissies bij Google. In de loop van deze technische procedure verwerft de onderneming Google kennis van persoonlijke informatie, zoals het IP-adres van de betrokkene, die Google onder meer dient om de oorsprong van bezoekers en klikken te begrijpen en vervolgens provisie schikkingen te creëren.
...
Op deze website heeft de verantwoordelijke componenten van DoubleClick van Google geïntegreerd. DoubleClick is een handelsmerk van Google, waaronder overwegend speciale online marketingoplossingen worden aangeboden aan reclamebureaus en uitgevers.
...
Op deze website heeft de verantwoordelijke geïntegreerde componenten van de onderneming Facebook. Facebook is een sociaal netwerk.
...
De exploitant van Facebook is Facebook, Inc., 1 Hacker Way, Menlo Park, CA 94025, Verenigde Staten. Als een persoon buiten de Verenigde Staten of Canada woont, is de verantwoordelijke de Facebook Ireland Ltd., 4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Ierland.

Bij elke oproep op een van de afzonderlijke pagina’s van deze internetwebsite, die wordt beheerd door de verantwoordelijke en waarin een Facebook component (Facebook invoegtoepassingen) is geïntegreerd, is de webbrowser op het informatietechnologie systeem van de betrokkene automatisch gevraagd om de weergave van het bijbehorende Facebook onderdeel van Facebook te downloaden via het Facebook onderdeel. Een overzicht van alle Facebook plug-ins kan worden geopend onder <a onclick="window.open (this.href); return false;"href="https://developers.facebook.com/docs/plugins/">https://developers.facebook.com/docs/plugins/</a>. Tijdens deze technische procedure wordt Facebook op de hoogte gebracht van welke specifieke subsite van onze website door de betrokkene werd bezocht.
