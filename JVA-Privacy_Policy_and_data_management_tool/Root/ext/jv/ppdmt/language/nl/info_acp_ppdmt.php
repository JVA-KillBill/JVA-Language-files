...
$lang = array_merge($lang, [
	...
	'ACP_JVPPDMT_HIDE_USERNAME_BOT'				=> 'Gebruikersnamen verbergen voor bots',
	...
	'ACP_JVPPDMT_TERM_OF_USE_RESET_EXPLAIN'		=> 'Als je de gebruiksvoorwaarden hebt gewijzigd, start je dit proces door gebruikers opnieuw te vragen de nieuwe gebruiksvoorwaarden te laten lezen en te accepteren.',
	...
	'ACP_JVPPDMT_VIEWER_GROUP'					=> 'Kijkersgroep',
	'ACP_JVPPDMT_VIEWER_GROUP_EXPLAIN'			=> 'De extensie maakt een nieuwe speciale groep aan met de naam <strong>“Geregistreerde kijkers”</strong>. Deze groep waarborgt de rechten van gebruikers die geen opslag van extra persoonlijke gegevens accepteren. Merk op dat de verantwoordelijke voor de verwerking altijd aandacht moet besteden aan de permissies van deze groep, dat deze altijd correct zijn ingesteld. De controller moet speciale rollen voor deze groep aanmaken. De geschiktheid moet altijd zo zijn ingesteld dat een gebruiker in deze groep nergens een formulier kan indienen. Houd er rekening mee dat, als je een nieuw forum maakt, je niet vergeet om de permissies van deze groep bij te werken. In dit geval is het goed om deze groep permissies in te stellen, zodat de gebruiker alleen kan bladeren en niets anders. Zorg ervoor dat je altijd het veld <strong>“NOOIT”</strong> permissies instelt voor andere acties, omdat dit de enige manier is om de toegangsrechten van de gebruiker van andere groepslidmaatschappen te overschrijven. Als je deze groep uitgeschakeld laat, zullen gebruikers, indien zij geen persoonlijke gegevensopslag accepteren, worden doorgestuurd om hun registratie te verwijderen.',
